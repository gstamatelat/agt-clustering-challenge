...
public class Evaluate {
    public static void main(String[] args) throws IOException {
        ...
        final String format = String.format("%%-%ds %%8.4f %%8.4f %%8.4f %%8.4f %%8.4f%%n", longest);
        final String headerFormat = String.format("%%-%ds %%8s %%8s %%8s %%8s %%8s%%n", longest);
        ...
        System.out.printf(headerFormat, "Partition", "Jaccard", "SMC", "F1", "NMI", "Pearson");
        for (Partition p : students) {
